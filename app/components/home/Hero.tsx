...
export default function Hero() {
  return (
    ...
    p-8 md:p-12 flex flex-col md:flex-row gap-10 items-center
  "
      >
  ...
  "
          >
            ...
            >
              <defs>
                ...
                <linearGradient id="shopSign" x1="0%" y1="0%" x2="100%" y2="0%">
              ...
              {/* Ground */}
              <rect y="260" width="400" height="140" fill="rgba(0,0,0,0.25)" />
              ...
              {/* Glow */}
              <circle cx="200" cy="200" r="140" fill="rgba(255,255,255,0.08)" />
            </svg>
          </div>
        </div>
        ...
        <div className="w-full md:w-2/3 space-y-4 text-center md:text-right">
          ...
          <p className="text-base md:text-lg text-primary leading-relaxed">
            این وب‌سایت فقط برای نمایش محصولات است. ثبت سفارش فقط از طریق تلگرام
            انجام می‌شود.
          </p>
